...
const SundaySchoolApp = () => {
    ...
    lessonDate: "December 21, 2025",
    lessonTitle: "The Strength of Covenant - Part 2",

    memoryVerse:
        "And God heard their groaning, and God remembered his covenant with Abraham, with Isaac, and with Jacob.",
    memoryVerseRef: "Exodus 2:24",

    introScriptures: [], // Added this field
    lessonIntroScriptures: [], // Added this field

    introduction:
        "In our last lesson we discovered that covenants are as strong as the divine witness. It is also imperative to reveal that a covenant is not a thing of leisure or some game but a very serious commitment. One is expected therefore to treat with utmost regard concerning every covenant made with God or before God and break covenants made with or by other gods through Jesus Christ.",

    aims:
        "To reveal the implications of covenants since man is surrounded or is obliged to surround himself by it.",

    objectives: "To cause man to be mindful of holy covenants through Christ.",

    lessonIntro:
        "We reviewed the first part of our text in the last lesson which showed how Israel entered into a covenant with Gibeon. The second part focuses on how God’s judgment tore Israel into strifes through famine as a result of Saul breaking the covenant as recorded in 2 Samuel 21:1–9. In today’s lesson we will consider the sides of a covenant as recorded in 2 Samuel 21:1–9.",
        
    lessonPoints: [
        {
            title: "Types",
            content:
                "There are several types of covenants that are intended to meet the particular need of the initiator. Some of which are covenant of peace, wealth and blessings, healing and health, priesthood, life, marriage, inheritance, etc.",
            scriptures: [],
            subPoints: [],
        },
        {
            title: "Facts About Covenants",
            content:
                "They are sacred, binding, kept with penalties for breaking, beneficial, proved with tokens, sealed with substances like blood, etc.",
            scriptures: [],
            subPoints: [],
        },
        {
            title: "General Implications",
            content: "The restrictions, demands, benefits, judgments for default.",
            scriptures: [],
            subPoints: [],
        },
        {
            ...
            content:
                "Most times covenants are represented with certain substance as a physical proof or reminder of its existence. For instance, the rainbow at Noah’s time (Genesis 9:13–17). Jacob also set a stone to represent his covenant with God (Genesis 28:22).",
            scriptures: [],
            subPoints: [],
        },
    ],
    ...
    conclusion:
        "Walk by the terms of your godly covenants and you will enjoy the benefits there attached unfailingly.",

    conclusionScriptures: [],

    prayerPoints: [
        "Heavenly Father, thank You for Your covenantal faithfulness. Teach me to honor every holy covenant and walk in Your ways.",
        "Lord, help me discern and break every ungodly covenant, oath, or agreement that has no place in my life.",
        "Father, grant me wisdom to recognize the benefits of Your covenants and apply them in my daily life.",
        "Lord Jesus, cover me with Your blood and protect me from the schemes of the enemy that seek to manipulate or bind me.",
        "Holy Spirit, guide me into understanding and walking in covenantal integrity, so that my life brings glory to God.",
    ],
});
                ...
                <div className="max-w-4xl w-full relative z-10">
                    <div className="text-center mb-12">
                        ...
                        <p className="text-xl opacity-80">
                            The Strength of Covenant - Part 2
                        </p>
                    </div>
